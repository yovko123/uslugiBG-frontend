...
const PendingBlog = () => {
        ...
        <div className="tab-sets mb-4">
          <div className="tab-contents-sets">
            <ul>
              ...
              <li>
                <Link to={routes.pendingBlog} className="active">
                  Pending Blog
                </Link>
              </li>
              <li>
 ...
 Edit
                ...
                <Link to="#">
                <Icon.Trash2 className="react-feather-custom me-2" /> Delete
                </Link>
              </div>
              <span>
               <Icon.AlertCircle className="react-feather-custom me-2" /> Pending
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="blog grid-blog">
          ...
          <div className="blog-content">
            <div className="blog-widget-image">
              ...
              <h6>
                <ImageWithBasePath src="/aassets/admin/img/icons/calendar.svg" alt="img" />
                28 Sep 2023
              </h6>
            </div>
            <h3 className="title">
        ...
        <div className="blog grid-blog">
          ...
          <div className="blog-content">
            <div className="blog-widget-image">
              ...
              <h6>
                <ImageWithBasePath src="assets/img/icons/calendar.svg" alt="img" />
                23 Sep 2023
              </h6>
            </div>
            <h3 className="title">
