...
interface BookStaffProps {
    handleNext: (staffId: number) => void;
    handlePrev?: () => void;
    serviceData?: any;
}

const BookStaff: React.FC<BookStaffProps> = ({
  handlePrev,
  handleNext,
  serviceData
}) => {
            ...
            <div className="book-card">
                ...
                <div className="row g-3">
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 1 ? 'selected' : ''}`} onClick={() => handleStaffSelect(1)}>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 2 ? 'selected' : ''}`} onClick={() => handleStaffSelect(2)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 3 ? 'selected' : ''}`} onClick={() => handleStaffSelect(3)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 4 ? 'selected' : ''}`} onClick={() => handleStaffSelect(4)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 5 ? 'selected' : ''}`} onClick={() => handleStaffSelect(5)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 6 ? 'selected' : ''}`} onClick={() => handleStaffSelect(6)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                                        src="assets/img/profiles/avatar-26.jpg"
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 7 ? 'selected' : ''}`} onClick={() => handleStaffSelect(7)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 8 ? 'selected' : ''}`} onClick={() => handleStaffSelect(8)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className={`card staff-card mb-0 ${selectedStaffId === 9 ? 'selected' : ''}`} onClick={() => handleStaffSelect(9)}>
                            <div className="card-body p-3 text-center">
                                <span className="avatar avatar-lg mx-auto mb-2">
                                    <ImageWithBasePath
